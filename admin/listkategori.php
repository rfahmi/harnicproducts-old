		<div class="row">
			...
			<div class="col-sm-4 text-right" style="padding-top: 15px">
				<div class="dropdown">
				  <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Filter By Kategori
		...
		<div class="table-responsive">
			<table class="table table-bordered table-striped table-hover">
				...
				<tbody>
					...
					$sqlcount ="select count(1) from Mstkategori a left join mstkategori b on a.kategori_parent=b.kategori_id left join mstkategori c on b.kategori_parent=c.kategori_id where a.kategori_id not in(select kategori_parent from mstkategori)";
				...
				//-----	 
					...
					<tr>
						...
						<?php
							$gambar=$data['kategori_gambar'];
							if (file_exists('../resource/img/kategori/'.$gambar)){
							  echo "<td><img src='../resource/img/kategori/$gambar' width='250' height='150' alt=''/></td>";
							}else{
							  echo "<td><img src='../resource/img/no-product-image.png' width='250' height='150' alt=''/></td>";
							}
						?>						
			...
			<div class="row">
				...
				<div class="col-xs-6 text-right">
                    ...
                    <ul class="pagination" style="margin: 0;">
                    	...
                    	?>
                    	<?php if ($page != $i): ?>
                    		<li><a href="index.php?hal=listkategori&page=<?=$i?>"><?=$i?></a></li>
                    	<?php else: ?>
